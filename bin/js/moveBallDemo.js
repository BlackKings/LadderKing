var moveBallDemo = (function () {
    function moveBallDemo() {
        this.dowmY = 300 / 60 * 1.5;
        this.dowmN = 300 / 120;
        this.fraction = 0;
     ...
     * 加载完成后的回调
     */
    moveBallDemo.prototype.onLoader = function () {
     ...
     * 监听鼠标点击后的动作
     */
    moveBallDemo.prototype.mouseDowm = function () {
        console.log("开始监听移动");
     ...
     * 监听鼠标放开
     */
    moveBallDemo.prototype.mouseUp = function () {
     ...
     * 监听鼠标移动
     */
    moveBallDemo.prototype.mouseMove = function () {
     ...
     * 球开始下落
     */
    moveBallDemo.prototype.ballDowm = function () {
        var ballY = this.ball_0.y;
        if (ballY > 900) {
            if (this.dowmY > 0) {
                this.dowmY *= -1;
            }
...
new moveBallDemo();
//# sourceMappingURL=moveBallDemo.js.map